    ...
    B: Backend,
{
    ...
    let playlist = draw_tracks(app.displayed_tracks.clone());
    rect.render_stateful_widget(playlist, player_chunks[0], &mut app.displayed_tracks.state);
...
fn draw_tracks(playlist: DisplayedTracks) -> List<'static> {
